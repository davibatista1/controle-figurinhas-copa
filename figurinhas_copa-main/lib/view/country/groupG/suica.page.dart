...
import 'package:figurinhas_copa/view_model/alemanha.view_model.dart';
import 'package:figurinhas_copa/view_model/belgica.view_model.dart';
import 'package:figurinhas_copa/view_model/brasil.view_model.dart';
import 'package:figurinhas_copa/view_model/costa_rica.view_model.dart';
import 'package:figurinhas_copa/view_model/espanha.view_model.dart';
import 'package:figurinhas_copa/view_model/servia.view_model.dart';
import 'package:figurinhas_copa/view_model/suica.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class SuicaPage extends StatelessWidget {
  const SuicaPage({Key? key}) : super(key: key);
...
class _ListCardState extends State<_ListCard> {
  late SuicaViewModel _viewModel;
  String name = "SUI ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<SuicaViewModel>(context, listen: false);
  }
