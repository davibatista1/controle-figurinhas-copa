...
class BrasilPage extends StatelessWidget {
  const BrasilPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/brasil.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late BrasilViewModel _viewModel;
  String name = "BRA ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<BrasilViewModel>(context, listen: false);
  }
