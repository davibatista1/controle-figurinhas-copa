...
import 'package:figurinhas_copa/view_model/camaroes.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class CamaroesPage extends StatelessWidget {
  const CamaroesPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/camaroes.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late CamaroesViewModel _viewModel;
  String name = "CMR ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<CamaroesViewModel>(context, listen: false);
  }
