...
class ServiaPage extends StatelessWidget {
  const ServiaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/servia.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late ServiaViewModel _viewModel;
  String name = "SRB ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<ServiaViewModel>(context, listen: false);
  }
