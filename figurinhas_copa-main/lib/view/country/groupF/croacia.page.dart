...
import 'package:figurinhas_copa/view_model/croacia.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class CroaciaPage extends StatelessWidget {
  const CroaciaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/croacia.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late CroaciaViewModel _viewModel;
  String name = "CRO ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<CroaciaViewModel>(context, listen: false);
  }
