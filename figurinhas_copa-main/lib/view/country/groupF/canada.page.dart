...
class CanadaPage extends StatelessWidget {
  const CanadaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/canada.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late CanadaViewModel _viewModel;
  String name = "CAN ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<CanadaViewModel>(context, listen: false);
  }
