...
import 'package:figurinhas_copa/view_model/marrocos.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class MarrocosPage extends StatelessWidget {
  const MarrocosPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/marrocos.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late MarrocosViewModel _viewModel;
  String name = "MAR ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<MarrocosViewModel>(context, listen: false);
  }
