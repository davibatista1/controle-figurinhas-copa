...
class BelgicaPage extends StatelessWidget {
  const BelgicaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/belgica.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late BelgicaViewModel _viewModel;
  String name = "BEL ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<BelgicaViewModel>(context, listen: false);
  }
