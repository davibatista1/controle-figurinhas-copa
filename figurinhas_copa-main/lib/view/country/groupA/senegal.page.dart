...
import 'package:figurinhas_copa/view_model/senegal.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class SenegalPage extends StatelessWidget {
  const SenegalPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/senegal.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late SenegalViewModel _viewModel;
  String name = "SEN ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<SenegalViewModel>(context, listen: false);
  }
