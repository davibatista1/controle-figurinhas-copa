...
class EquadorPage extends StatelessWidget {
  const EquadorPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/equador.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late EquadorViewModel _viewModel;
  String name = "ECU ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<EquadorViewModel>(context, listen: false);
  }
