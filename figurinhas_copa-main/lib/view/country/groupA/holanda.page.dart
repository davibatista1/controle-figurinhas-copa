...
import 'package:figurinhas_copa/view_model/holanda.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class HolandaPage extends StatelessWidget {
  const HolandaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/holanda.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late HolandaViewModel _viewModel;
  String name = "NED ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<HolandaViewModel>(context, listen: false);
  }
