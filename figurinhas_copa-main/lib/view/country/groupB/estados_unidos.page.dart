...
import 'package:figurinhas_copa/view_model/estados_unidos.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class EstadosUnidosPage extends StatelessWidget {
  const EstadosUnidosPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/estados_unidos.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late EstadosUnidosViewModel _viewModel;
  String name = "USA ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<EstadosUnidosViewModel>(context, listen: false);
  }
