...
class GalesPage extends StatelessWidget {
  const GalesPage({Key? key}) : super(key: key);
...
class _ListCardState extends State<_ListCard> {
  late GalesViewModel _viewModel;
  String name = "WAL ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<GalesViewModel>(context, listen: false);
  }
