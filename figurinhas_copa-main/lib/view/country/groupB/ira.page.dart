...
class IraPage extends StatelessWidget {
  const IraPage({Key? key}) : super(key: key);
...
class _ListCardState extends State<_ListCard> {
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<IraViewModel>(context, listen: false);
  }
