...
import 'package:figurinhas_copa/view_model/inglaterra.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class InglaterraPage extends StatelessWidget {
  const InglaterraPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/inglaterra.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late InglaterraViewModel _viewModel;
  String name = "ENG ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<InglaterraViewModel>(context, listen: false);
  }
