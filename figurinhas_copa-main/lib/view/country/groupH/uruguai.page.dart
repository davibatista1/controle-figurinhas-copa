...
import 'package:figurinhas_copa/view_model/uruguai.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class UruguaiPage extends StatelessWidget {
  const UruguaiPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/uruguai.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late UruguaiViewModel _viewModel;
  String name = "URU ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<UruguaiViewModel>(context, listen: false);
  }
