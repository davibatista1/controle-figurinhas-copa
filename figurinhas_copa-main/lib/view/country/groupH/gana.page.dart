...
import 'package:figurinhas_copa/view_model/gana.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class GanaPage extends StatelessWidget {
  const GanaPage({Key? key}) : super(key: key);
...
class _ListCardState extends State<_ListCard> {
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<GanaViewModel>(context, listen: false);
  }
