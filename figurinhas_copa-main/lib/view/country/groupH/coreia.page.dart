...
import 'package:figurinhas_copa/view_model/coreia.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class CoreiaPage extends StatelessWidget {
  const CoreiaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/coreia.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late CoreiaViewModel _viewModel;
  String name = "KOR ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<CoreiaViewModel>(context, listen: false);
  }
