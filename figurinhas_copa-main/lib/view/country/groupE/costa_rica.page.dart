...
class CostaRicaPage extends StatelessWidget {
  const CostaRicaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/costa_rica.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late CostaRicaViewModel _viewModel;
  String name = "CRC ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<CostaRicaViewModel>(context, listen: false);
  }
