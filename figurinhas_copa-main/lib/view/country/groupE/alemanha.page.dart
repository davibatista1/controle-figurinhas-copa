...
class AlemanhaPage extends StatelessWidget {
  const AlemanhaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/alemanha.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late AlemanhaViewModel _viewModel;
  String name = "GER ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<AlemanhaViewModel>(context, listen: false);
  }
