...
import 'package:figurinhas_copa/view_model/japao.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class JapaoPage extends StatelessWidget {
  const JapaoPage({Key? key}) : super(key: key);
...
class _ListCardState extends State<_ListCard> {
  late JapaoViewModel _viewModel;
  String name = "JPN ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<JapaoViewModel>(context, listen: false);
  }
