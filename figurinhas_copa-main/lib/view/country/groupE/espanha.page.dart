...
class EspanhaPage extends StatelessWidget {
  const EspanhaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/espanha.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late EspanhaViewModel _viewModel;
  String name = "ESP ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<EspanhaViewModel>(context, listen: false);
  }
