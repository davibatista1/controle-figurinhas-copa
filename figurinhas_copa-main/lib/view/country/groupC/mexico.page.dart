...
import 'package:figurinhas_copa/view_model/mexico.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class MexicoPage extends StatelessWidget {
  const MexicoPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/mexico.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late MexicoViewModel _viewModel;
  String name = "MEX ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<MexicoViewModel>(context, listen: false);
  }
