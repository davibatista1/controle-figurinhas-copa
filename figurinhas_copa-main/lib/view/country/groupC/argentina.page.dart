...
import 'package:figurinhas_copa/view_model/argentina.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class ArgentinaPage extends StatelessWidget {
  const ArgentinaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/argentina.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late ArgentinaViewModel _viewModel;
  String name = "ARG ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<ArgentinaViewModel>(context, listen: false);
  }
