...
import 'package:figurinhas_copa/view_model/arabia.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class ArabiaPage extends StatelessWidget {
  const ArabiaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/arabia.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late ArabiaViewModel _viewModel;
  String name = "KSA ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<ArabiaViewModel>(context, listen: false);
  }
