...
import 'package:figurinhas_copa/view_model/polonia.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class PoloniaPage extends StatelessWidget {
  const PoloniaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/polonia.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late PoloniaViewModel _viewModel;
  String name = "POL ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<PoloniaViewModel>(context, listen: false);
  }
