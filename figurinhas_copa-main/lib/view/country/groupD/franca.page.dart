...
import 'package:figurinhas_copa/view_model/franca.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class FrancaPage extends StatelessWidget {
  const FrancaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/franca.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late FrancaViewModel _viewModel;
  String name = "FRA ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<FrancaViewModel>(context, listen: false);
  }
