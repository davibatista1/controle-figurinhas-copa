    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/australia.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late AustraliaViewModel _viewModel;
  String name = "AUS ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<AustraliaViewModel>(context, listen: false);
  }
