...
import 'package:figurinhas_copa/view_model/tunisia.view_model.dart';
import 'package:figurinhas_copa/widgets/card.widget.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class TunisiaPage extends StatelessWidget {
  const TunisiaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/tunisia.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late TunisiaViewModel _viewModel;
  String name = "TUN ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<TunisiaViewModel>(context, listen: false);
  }
