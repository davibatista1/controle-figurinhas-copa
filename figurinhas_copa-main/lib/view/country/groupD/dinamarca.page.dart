...
class DinamarcaPage extends StatelessWidget {
  const DinamarcaPage({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Image.asset("assets/dinamarca.jpeg"),
...
class _ListCardState extends State<_ListCard> {
  late DinamarcaViewModel _viewModel;
  String name = "DEN ";
  ...
  void initState() {
    super.initState();
    _viewModel = Provider.of<DinamarcaViewModel>(context, listen: false);
  }
